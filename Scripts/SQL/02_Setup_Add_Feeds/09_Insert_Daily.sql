...
SET @FeedName = 'LVMPD Calls For Service Daily - GeoJSON'
SET @FeedNameSQL = 'LVMPD_Calls_For_Service_Daily'

--=============================================================================
-- Add an entry in the feed table for the Daily Calls For Service file
--=============================================================================
...
SELECT
	...
	, feedDescription = 'Daily extracts of GeoJSON files for LVMPD Calls for Service from 30-Day feed'
	, feedDataFolder = 'Z:\Las_Vegas_Crime\Data\LVMPD\LVMPD_Calls_For_Service\FileTypes\GeoJSON\Daily\'
	, feedDataFileConvention = 'LVMPD_Calls_For_Service_20*.geojson'
