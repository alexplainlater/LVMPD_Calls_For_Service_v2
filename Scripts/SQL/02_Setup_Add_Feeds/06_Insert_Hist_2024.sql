...
SET @FeedName = 'LVMPD Calls For Service 2024 - GeoJSON'
SET @FeedNameSQL = 'LVMPD_Calls_For_Service_2024'

--=============================================================================
-- Add an entry in the feed table for the 2024 Calls For Service historical file
--=============================================================================
...
SELECT
	...
	, feedDescription = 'GeoJSON files for LVMPD Calls for Service for year 2024'
	, feedDataFolder = 'Z:\Las_Vegas_Crime\Data\LVMPD\LVMPD_Calls_For_Service\FileTypes\GeoJSON\Historical\2024\'
	, feedDataFileConvention = 'LVMPD_Calls_For_Service_2024_*.geojson'
	, externalID = '8bd45bf26d1d471c89e875c0c1366dbf'
...
-- 2024: https://services.arcgis.com/jjSk6t82vIntwDbs/arcgis/rest/services/LVMPD_Calls_For_Service_2024/FeatureServer/3
...
--incDtUTC (type: esriFieldTypeDate, alias: incDtUTC, SQL Type: sqlTypeOther, length: 8, nullable: true, editable: true)
--upDtUTC (type: esriFieldTypeDate, alias: upDtUTC, SQL Type: sqlTypeOther, length: 8, nullable: true, editable: true)
...
SELECT
	...
	, fieldDataType = 'VARCHAR(5)' --Documentation says length is 10 but i can see it's smaller
	, fieldNullable = 1
...
SELECT
	fieldName = 'incDtUTC'
	, fieldNameSrc = 'properties.incDtUTC'
	, fieldAlias = 'incDtUTC'
	, fieldDataType = 'DATETIMEOFFSET(0)'
	, fieldNullable = 1
	, fieldDescription = ''
	, fieldTransform = 'CONVERT( DATETIME, SUBSTRING( incDtUTC, 6, LEN( incDtUTC ) - 9 ), 113 ) AT TIME ZONE ''UTC'''
	, feedID = f.feedID
...
SELECT
	fieldName = 'upDtUTC'
	, fieldNameSrc = 'properties.upDtUTC'
	, fieldAlias = 'upDtUTC'
	, fieldDataType = 'DATETIMEOFFSET(0)'
	, fieldNullable = 1
	, fieldDescription = ''
...
SELECT
	fieldName = 'GlobalID'
	, fieldNameSrc = 'properties.GlobalID'
	, fieldAlias = 'GlobalID'
	, fieldDataType = 'VARCHAR(38)'
	, fieldNullable = 1
	, fieldDescription = ''
	, fieldTransform = 'NULLIF( LTRIM( RTRIM( GlobalID ) ), '''' )'
	, feedID = f.feedID
