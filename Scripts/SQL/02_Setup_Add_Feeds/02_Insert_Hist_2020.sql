...
SET @FeedName = 'LVMPD Calls For Service 2020 - GeoJSON'
SET @FeedNameSQL = 'LVMPD_Calls_For_Service_2020'

--=============================================================================
-- Add an entry in the feed table for the 2020 Calls For Service historical file
--=============================================================================
...
SELECT
	...
	, feedDescription = 'GeoJSON files for LVMPD Calls for Service for year 2020'
	, feedDataFolder = 'Z:\Las_Vegas_Crime\Data\LVMPD\LVMPD_Calls_For_Service\FileTypes\GeoJSON\Historical\2020\'
	, feedDataFileConvention = 'LVMPD_Calls_For_Service_2020_*.geojson'
	, externalID = 'c61febca7d5d4fb1a4bd5c7c33e8e2c0'
...
-- 2020: https://services.arcgis.com/jjSk6t82vIntwDbs/arcgis/rest/services/LVMPD_Calls_For_Service_2020/FeatureServer/0
...
--block_address (type: esriFieldTypeString, alias: location, SQL Type: sqlTypeOther, length: 60, nullable: true, editable: true)
...
SELECT
	fieldName = 'Address'
	, fieldNameSrc = 'properties.block_address'
	, fieldAlias = 'Address'
