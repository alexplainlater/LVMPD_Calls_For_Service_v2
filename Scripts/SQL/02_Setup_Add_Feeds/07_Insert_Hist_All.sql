...
SET @FeedName = 'LVMPD Calls For Service All - GeoJSON'
SET @FeedNameSQL = 'LVMPD_Calls_For_Service_All'

--=============================================================================
-- Add an entry in the feed table for the All Calls For Service historical file
--=============================================================================
...
SELECT
	...
	, feedDescription = 'GeoJSON files for an All extract of LVMPD Calls for Service. Looks like from 1/1/2019 to 2/29/2024'
	, feedDataFolder = 'Z:\Las_Vegas_Crime\Data\LVMPD\LVMPD_Calls_For_Service\FileTypes\GeoJSON\Historical\All\'
	, feedDataFileConvention = 'LVMPD_Calls_For_Service_All_*.geojson'
	, externalID = 'c94ab385012b44f59d7e28d39a468ead'
...
-- All: https://services.arcgis.com/jjSk6t82vIntwDbs/arcgis/rest/services/LVMPD_Calls_For_Service_All/FeatureServer/0
