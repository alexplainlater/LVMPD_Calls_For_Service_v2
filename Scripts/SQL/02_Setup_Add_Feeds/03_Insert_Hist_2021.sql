...
SET @FeedName = 'LVMPD Calls For Service 2021 - GeoJSON'
SET @FeedNameSQL = 'LVMPD_Calls_For_Service_2021'

--=============================================================================
-- Add an entry in the feed table for the 2021 Calls For Service historical file
--=============================================================================
...
SELECT
	...
	, feedDescription = 'GeoJSON files for LVMPD Calls for Service for year 2021'
	, feedDataFolder = 'Z:\Las_Vegas_Crime\Data\LVMPD\LVMPD_Calls_For_Service\FileTypes\GeoJSON\Historical\2021\'
	, feedDataFileConvention = 'LVMPD_Calls_For_Service_2021_*.geojson'
	, externalID = 'fce7c93c6ec94c06b8c1b128ecfe89e7'
...
-- 2021: https://services.arcgis.com/jjSk6t82vIntwDbs/arcgis/rest/services/LVMPD_Calls_For_Service_2021/FeatureServer/0
--OBJECTID (type: esriFieldTypeOID, alias: OBJECTID, SQL Type: sqlTypeOther, length: 0, nullable: false, editable: false)
--incidentnumber (type: esriFieldTypeString, alias: incidentnumber, SQL Type: sqlTypeOther, length: 200, nullable: true, editable: true)
--IncidentTypeCode (type: esriFieldTypeString, alias: IncidentTypeCode, SQL Type: sqlTypeOther, length: 20, nullable: true, editable: true)
...
--incidenttypedescription (type: esriFieldTypeString, alias: incidenttypedescription, SQL Type: sqlTypeOther, length: 512, nullable: true, editable: true)
--disposition (type: esriFieldTypeString, alias: disposition1, SQL Type: sqlTypeOther, length: 100, nullable: true, editable: true)
--incidentdate (type: esriFieldTypeDate, alias: incidentdate, SQL Type: sqlTypeOther, length: 8, nullable: true, editable: true)
...
--dayofyear (type: esriFieldTypeInteger, alias: dayofyear, SQL Type: sqlTypeOther, nullable: true, editable: true)
--quarterofyear (type: esriFieldTypeInteger, alias: quarterofyear, SQL Type: sqlTypeOther, nullable: true, editable: true)
--location (type: esriFieldTypeString, alias: block_address, SQL Type: sqlTypeOther, length: 60, nullable: true, editable: true)
...
SELECT
	...
	, fieldTransform = 'REPLACE( GeometryCRS, ''urn:ogc:def:crs:OGC:1.3:CRS84'', ''EPSG:4326'' )'
	, feedID = f.feedID
