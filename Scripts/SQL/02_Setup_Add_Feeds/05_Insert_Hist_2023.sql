...
SET @FeedName = 'LVMPD Calls For Service 2023 - GeoJSON'
SET @FeedNameSQL = 'LVMPD_Calls_For_Service_2023'

--=============================================================================
-- Add an entry in the feed table for the 2023 Calls For Service historical file
--=============================================================================
...
SELECT
	...
	, feedDescription = 'GeoJSON files for LVMPD Calls for Service for year 2023'
	, feedDataFolder = 'Z:\Las_Vegas_Crime\Data\LVMPD\LVMPD_Calls_For_Service\FileTypes\GeoJSON\Historical\2023\'
	, feedDataFileConvention = 'LVMPD_Calls_For_Service_2023*.geojson'
	, externalID = 'c0ea564d32f54450af8218d8e962934a'
...
-- 2023: https://services.arcgis.com/jjSk6t82vIntwDbs/arcgis/rest/services/LVMPD_Calls_For_Service_2023/FeatureServer/10
...
SELECT
	...
	, fieldTransform = 'IncidentDate' --new format in ISO 8601 format
	, feedID = f.feedID
