...
SET @FeedName = 'LVMPD Calls For Service 2022 - GeoJSON'
SET @FeedNameSQL = 'LVMPD_Calls_For_Service_2022'

--=============================================================================
-- Add an entry in the feed table for the 2022 Calls For Service historical file
--=============================================================================
...
SELECT
	...
	, feedDescription = 'GeoJSON files for LVMPD Calls for Service for year 2022'
	, feedDataFolder = 'Z:\Las_Vegas_Crime\Data\LVMPD\LVMPD_Calls_For_Service\FileTypes\GeoJSON\Historical\2022\'
	, feedDataFileConvention = 'LVMPD_Calls_For_Service_2022_*.geojson'
	, externalID = 'e9c41bfd11454010a535cf02fb4a3ac3'
...
-- 2022: https://services.arcgis.com/jjSk6t82vIntwDbs/arcgis/rest/services/LVMPD_Calls_For_Service_2022/FeatureServer/0
...
--Classification (type: esriFieldTypeString, alias: Classification, SQL Type: sqlTypeOther, length: 30, nullable: true, editable: true)
